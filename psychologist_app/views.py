...
import os
import json
from django.http import JsonResponse, HttpResponse, HttpResponseBadRequest, HttpResponseServerError, HttpResponseNotModified
...
# Lazily created singleton - same pattern as FastAPI backend
...
def psychologist_endpoint(request):
    ...
    try:
        ...
        # Initialize psychologist if needed
        if psychologist is None:
            psychologist = AIPsychologist()
        
        # Start session if needed
        if psychologist.current_session_id is None or psychologist.user_id != (user_id or "default"):
            psychologist.start_session(user_id or "default")
